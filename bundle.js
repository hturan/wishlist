...
/***/ function(module, exports, __webpack_require__) {
	...
	var App = function (_React$Component) {
	  ...
	  _createClass(App, [{
	    ...
	    key: 'handleItemUpdate',
	    value: function handleItemUpdate(listId, itemId, data) {
	      ...
	      return this.state.auth ? _react2.default.createElement(
	        ...
	        Object.keys(this.state.lists).map(function (listId) {
	          return _react2.default.createElement(_List2.default, _extends({
	            ...
	            handleItemUpdate: _this4.handleItemUpdate.bind(_this4, listId),
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        this.props.items ? _react2.default.createElement(
	          'ul',
	          { className: 'items' },
	          Object.keys(this.props.items).map(function (itemId) {
	            return _react2.default.createElement(_Item2.default, _extends({
	              key: itemId,
	              handleItemUpdate: _this3.props.handleItemUpdate.bind(_this3, itemId),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Item = function (_React$Component) {
	  ...
	  _createClass(Item, [{
	    key: 'handleUpdateToggle',
	    value: function handleUpdateToggle() {
	      if (this.state.editing) {
	        this.props.handleItemUpdate(_extends({
	    ...
	    key: 'unformatAmount',
	    value: function unformatAmount(amountString) {
	      var currencies = ['£', '$', '€'];
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        'li',
	        { className: (0, _classnames2.default)('item', { 'editing': this.state.editing }) },
	        _react2.default.createElement(
	          'span',
	          { className: 'item-price' },
	          this.state.editing ? _react2.default.createElement('input', {
	            type: 'text',
	            ref: function ref(_ref) {
	              return _this2.amountInput = _ref;
	            },
	        ...
	        _react2.default.createElement(
	          ...
	          this.state.editing ? _react2.default.createElement('input', {
	            ...
	            ref: function ref(_ref2) {
	              return _this2.titleInput = _ref2;
	            },
	            ...
	            'a',
	            { className: 'item-link', href: this.props.url, target: '_blank' },
	            this.props.title
	          )
	        ),
	        _react2.default.createElement(
	          'a',
	          { className: 'delete-link', onClick: this.props.handleItemDelete },
	          '✖'
	        ),
	        _react2.default.createElement(
	          'a',
	          { className: 'edit-link', onClick: this.handleUpdateToggle.bind(this) },
	          '✎'
	        )
	      );
	    }
