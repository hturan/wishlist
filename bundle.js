...
/***/ function(module, exports, __webpack_require__) {
	...
	var _firebase = __webpack_require__(160);
	  ...
	  _createClass(App, [{
	    ...
	    value: function connectFirebase() {
	      ...
	      this.firebase.on('value', function (snapshot) {
	        console.log('Authenticated as', _this2.state.auth.password.email);
	  ...
	  _createClass(List, [{
	    ...
	    value: function handleURLInput(event) {
	      ...
	      if (event.target.value) {
	        fetch('http://localhost:3001/details/' + window.encodeURIComponent(event.target.value)).then(function (response) {
	          return response.json();
	        }).then(function (json) {
	          return _this2.amountInput.value = json.amount;
	        });
	      }
	    }
	  }, {
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement('input', { ref: function ref(_ref) {
	              return _this3.titleInput = _ref;
	            }, type: 'text', placeholder: 'Title' }),
	          _react2.default.createElement('input', { ref: function ref(_ref2) {
	              return _this3.amountInput = _ref2;
	            }, type: 'text', placeholder: 'Amount' }),
	          _react2.default.createElement('input', { onInput: this.handleURLInput.bind(this), ref: function ref(_ref3) {
	              return _this3.urlInput = _ref3;
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          this.props.currency,
	          this.props.amount.toString().indexOf('.') > -1 ? this.props.amount : this.props.amount + ".00"
	        ),
	        _react2.default.createElement(
	          "span",
